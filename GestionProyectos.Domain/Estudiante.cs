...
namespace GestionProyectos.Domain
{
    ...
    {
        public Estudiante(string id, string nombres, string apellidos, string numeroIdentificacion, string correo, string contraseña) : base(id, nombres, apellidos, numeroIdentificacion, correo, contraseña)
        {
        }
